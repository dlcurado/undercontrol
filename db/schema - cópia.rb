...
ActiveRecord::Schema.define(version: 20180226234416) do
  ...
  create_table "proposta", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["evento_id"], name: "index_proposta_on_evento_id", using: :btree
  end
  ...
  create_table "propostas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["eventos_id"], name: "index_propostas_on_eventos_id", using: :btree
  end
  ...
  add_foreign_key "proposta", "eventos"
  add_foreign_key "propostas", "eventos", column: "eventos_id"
end
